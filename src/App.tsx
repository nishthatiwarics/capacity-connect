...
export default function App() {
  ...
  // Additional Modals: Resume, Video Player, Upload Demo, Role Switcher
  ...
  return (
    <div className="bg-pink-blue-mesh min-h-screen flex flex-row font-sans relative text-slate-900 selection:bg-[#ea580c] selection:text-white overflow-x-hidden">
      {/* Ambient Pink and Blue atmospheric background glows */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[-10%] left-[-5%] w-[600px] h-[600px] bg-pink-300/25 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute top-[20%] right-[-10%] w-[650px] h-[650px] bg-sky-300/25 rounded-full blur-3xl animate-float-reverse" />
        <div className="absolute bottom-[-10%] left-[25%] w-[700px] h-[700px] bg-rose-200/20 rounded-full blur-3xl" />
      </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        ...
        {/* Quick-Access Ribbon with Black Highlight Aesthetic */}
        <div className="border-b border-slate-200/80 px-6 py-2.5 bg-white/80 backdrop-blur-md flex flex-wrap items-center justify-between gap-3 text-xs">
          <div className="flex items-center gap-2">
            <span className="text-[11px] font-mono uppercase tracking-wider font-bold text-slate-400">
              Active Cockpit:
            </span>
            <span className="px-2.5 py-1 rounded-lg text-xs font-bold flex items-center gap-1.5 bg-black text-white shadow-xs">
              {currentRole === 'Admin' ? '🔒 Admin HQ (Sarah Jenkins / Dr. M. Mohapatra)' : currentRole === 'Trainer' ? '📋 Trainer (Dr. Someshwar Rao)' : '👤 Trainee (Julianne Moore)'}
            </span>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold border border-slate-200 hover:border-black bg-white text-black transition-all shadow-xs"
            ...
            >
              ...
              <span className="font-semibold">{studentProfile.currentAnimalRank}</span>
              <span className="hidden sm:inline font-mono opacity-80 text-[11px]">
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold border border-slate-200 hover:border-black bg-white text-black transition-all shadow-xs"
            >
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-bold bg-black hover:bg-neutral-800 text-white transition-all shadow-xs"
            >
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-xl transition-all shadow-sm ${
                        isBright
                          ...
                          : 'bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold shadow-[0_0_15px_rgba(16,185,129,0.3)]'
                      }`}
                    >
      ...
      {/* 4. Free Demo Video Lecture Upload Modal */}
      <UploadDemoLectureModal
        isOpen={isUploadLectureOpen}
